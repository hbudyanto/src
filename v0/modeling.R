...
#setwd("~/PycharmProjects/dissertation")
...
# SaveRDS(xgbTree_caret, "model/xgbTree_caret.rds")
saveRDS(xgbTree_caret, paste('model/xgbTree_caret',rand,'.seed',568,'.rds',sep=''))

####### 
readRDS(paste('model/xgbTree_caret',rand,'.seed',568,'.rds',sep=''))
...
# load the model
# xgbTree_caret <- readRDS("model/xgbTree_caret.rds")
print(xgbTree_caret)
...
# saveRDS(glmnFit, "model/glmnFit.rds")
...
# store model
# saveRDS(svmRFitFull, "model/svmRFitFull.rds")
...
plot(svmPRoc, type = "s", col = rgb(.2, .2, .2, .2), legacy.axes = TRUE)
